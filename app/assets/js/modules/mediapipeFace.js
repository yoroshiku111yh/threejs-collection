...
export default class MediaPipeFace {
    constructor() {
        ...
        //this.isLoadedAllMask = false;
        //this.eventChoiceTypeInput();
        //this.init();
        this.init();
    }
    init() {
        this.initImageFaceMesh1();
        //this.phaseLoadTextureMask();
        //this.requestAnimate();
    }
    initImageFaceMesh1() {
        ...
        this.faceMeshImage1 = new FaceMeshWithImage({
            size: {
                ...
                height: document.getElementById("mediapipe-image-input").height
            },
            inputImage: document.getElementById("mediapipe-image-input")
        });
    ...
    //     requestAnimationFrame(this.requestAnimate.bind(this));
    // }
    // phaseLoadTextureMask() {
    //     for (let i = 0; i < materialsEffect.length; i++) {
    //         const mat = materialsEffect[i];
    //         switch (mat.type) {
    //             case "2d":
    //                 this.load2dMask({ src: mat.src, name: mat.name });
    //                 break;
    //             case "3d":
    //                 this.load3dMask({ src: mat.src, name: mat.name });
    //                 break;
    //         }
    //     }
    // }
    ...
    //         textureSrc: src,
    //         callbackLoaded: (tex) => {
    //             this.loadedMaterials.push(tex);
    //         }
    //     });
    //     this.mask2dRendered[name] = texture;
    // }
    // load3dMask({ src, name }) {
    //     const model = new Object3dModel({
    //         modelSrc: src,
    //         callbackLoaded: (obj) => {
    //             this.loadedMaterials.push(obj);
    //         }
    //     });
    //     this.objectModels3dRendered[name] = model;
    // }
    // eventLoadedAllMask() {
    //     if (this.loadedMaterials.length !== materialsEffect.length) return;
    //     if(!this.isLoadedAllMask){
    //         this.isLoadedAllMask = true;
    //         this.mainPhase();
    //     }
    // }
    // mainPhase(){
    //     console.log(this.objectModels3dRendered);
    //     console.log(this.mask2dRendered);
    // }
    //////////////////
